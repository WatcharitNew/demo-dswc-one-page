...
export const ReporterCustomizableComponent = ({ box, onClick, imgUrl }) => {
  return (
    <div
      onClick={onClick}
      className={clsx("absolute flex items-center justify-center hover:outline hover:outline-blue-500 cursor-pointer bg-gray-200", imgUrl ? "box-parent-edit" : "box-parent-add")}
      style={{
